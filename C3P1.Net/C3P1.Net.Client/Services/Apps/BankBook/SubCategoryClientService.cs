...
namespace C3P1.Net.Client.Services.Apps.BankBook
{
    public class SubCategoryClientService(HttpClient httpClient) : ISubCategoryService
    {
        ...
        {
            var result = await httpClient.PostAsJsonAsync($"/api/apps/bankbook/subcategory/add", subCategory);
        ...
        {
            var result = await httpClient.DeleteAsync($"/api/apps/bankbook/subcategory/delete/{subCategoryId}");
        ...
        {
            var result = await httpClient.GetFromJsonAsync<List<SubCategory>>($"/api/apps/bankbook/subcategory/list");
        ...
        {
            var result = await httpClient.GetFromJsonAsync<SubCategory?>($"/api/apps/bankbook/subcategory/get/{subCategoryId}");
        ...
        {
            var result = await httpClient.PutAsJsonAsync($"/api/apps/bankbook/subcategory/update", subCategory);
        ...
        {
            var result = await httpClient.GetFromJsonAsync<SubCategory?>($"/api/apps/bankbook/subcategory/get/code/{code}");
        ...
        {
            var result = await httpClient.GetFromJsonAsync<List<SubCategory>>($"/api/apps/bankbook/subcategory/list/category/{categoryId}");
        ...
        {
            var result = await httpClient.GetFromJsonAsync<List<SubCategory>>($"/api/apps/bankbook/subcategory/list/category/code/{categoryCode}");
