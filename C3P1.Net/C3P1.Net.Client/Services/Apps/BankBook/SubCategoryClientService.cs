...
namespace C3P1.Net.Client.Services.Apps.BankBook
{
    public class SubCategoryClientService(HttpClient httpClient) : ISubCategoryService
    {
        ...
        {
            var result = await _httpClient.PostAsJsonAsync($"/api/apps/bankbook/subcategory", subCategory);
        ...
        {
            var result = await _httpClient.DeleteAsync($"/api/apps/bankbook/subcategory/{subCategoryId}");
        ...
        {
            var result = await _httpClient.GetFromJsonAsync<List<SubCategory>>($"/api/apps/bankbook/subcategory");
        ...
        {
            var result = await _httpClient.GetFromJsonAsync<SubCategory?>($"/api/apps/bankbook/subcategory/{subCategoryId}");
        ...
        {
            var result = await _httpClient.PutAsJsonAsync($"/api/apps/bankbook/subcategory", subCategory);
