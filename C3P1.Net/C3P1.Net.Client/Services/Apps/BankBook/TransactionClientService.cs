...
namespace C3P1.Net.Client.Services.Apps.BankBook
{
    public class TransactionClientService(HttpClient httpClient) : ITransactionService
    {
        ...
        {
            var result = await _httpClient.PostAsJsonAsync($"/api/bankbook/transaction/add", transaction);
        ...
        {
            var result = await _httpClient.DeleteAsync($"/api/bankbook/transaction/delete/{transactionId}");
        ...
        {
            var result = await _httpClient.GetFromJsonAsync<Transaction?>($"/api/bankbook/transaction/get/{transactionId}");
        ...
        {
            var result = await _httpClient.GetFromJsonAsync<List<Transaction>>($"/api/bankbook/transaction/list");
        ...
        {
            var result = await _httpClient.GetFromJsonAsync<List<Transaction>>($"/api/banobook/transaction/list/account/{accountId}");
        ...
        {
            var result = await _httpClient.GetFromJsonAsync<List<Transaction>>($"/api/bankbook/transaction/list/subcategory/{subCategoryId}");
        ...
        {
            var result = await _httpClient.PutAsJsonAsync($"/api/bankbook/transaction/update", transaction);
